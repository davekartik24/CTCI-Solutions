...
public class Successor<T extends Comparable> {
	...
	public static void main(String[] args) {
		...
		Successor<Integer> testInstance = new Successor<>();
		...
		System.out.println(testInstance.successor(inputNodeOne).value + "successor");
